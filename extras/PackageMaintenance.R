...
OhdsiRTools::checkUsagePackage("coverAge")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/coverAge.pdf")
shell("R CMD Rd2pdf ./ --output=extras/coverAge.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("coverAge")
